 ...
 *
 */
-(void) bluetoothDevice:(JOBluetoothDevice *)device characteristic:(CBCharacteristic *)characteristic didDataReceived:(NSData *)data;
@end

@interface JOBluetoothDevice : NSObject<CBPeripheralDelegate,JOBluetoothDataPacketDelegate,IScanDeviceProtocol>
{
    ...
    Boolean dataCharacteristicWriteWithoutResponse;
    Boolean dataCharacteristicHostRecvedPacketSequenceWithoutResponse;
    Boolean dataCharacteristicHostRecvedErrorPacketSequenceWithoutResponse;
}
...
@property (nonatomic ,copy) onWriteSuccess writeSuccess;
@property (nonatomic ,copy) onWriteFail writeFail;
...
-(Boolean) writeData:(NSData *)data successCallback:(onWriteSuccess)success failCallback:(onWriteFail)fail;
